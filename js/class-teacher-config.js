...
export const SUBJECT_ALIASES = new Map([
  ...
  ["CHEM", "Chemie"],
  ["CHEMIE", "Chemie"],
  ["AIDT", "Design Thinking"],
  ["DT", "Design Thinking"],
  ["DESIGN THINKING", "Design Thinking"],
  ["DEC", "Duurzaamheid en economie"],
  ["DUURZAAMHEID EN ECONOMIE", "Duurzaamheid en economie"],
  ["DIGI", "Digiwiskunde"],
  ...
  ["MUZIKALE OPVOEDING", "Muzikale opvoeding"],
  ["NATWE", "Natuurwetenschappen"],
  ["NATUURWETENSCHAPPEN", "Natuurwetenschappen"],
  ["NED", "Nederlands"],
  ["NEDERLANDS", "Nederlands"],
  ["PMS", "Project Mens & Samenleving"],
  ["PROJECT MENS SAMENLEVING", "Project Mens & Samenleving"],
  ["PROJECT MENS & SAMENLEVING", "Project Mens & Samenleving"],
  ["SAV", "SE²AL"],
  ["SE2AL", "SE²AL"],
  ["SEAL", "SE²AL"],
